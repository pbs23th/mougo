...
class TradeAPI(Client):
    ...
    # Place Order
    def place_order(self, instId, tdMode, side, ordType, sz, clOrdId=None, tag=None, posSide=None, px=None,
                    reduceOnly=None):
        params = {'instId': instId, 'tdMode': tdMode, 'side': side, 'ordType': ordType, 'sz': sz,
                  'clOrdId': clOrdId, 'px': px}
    ...
    def get_orders_history(self, instType, uly=None, instId=None, ordType=None, state=None, after=None, before=None, limit=None):
        params = {'instType': instType, 'instId': instId, 'state': state, 'limit': limit}
